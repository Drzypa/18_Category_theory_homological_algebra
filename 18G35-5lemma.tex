...
\usepackage{pmmeta}
\pmcanonicalname{5lemma}
\pmcreated{2013-03-22 13:51:33}
\pmmodified{2013-03-22 13:51:33}
...
\pmsynonym{five-lemma}{5lemma}
\pmsynonym{5-lemma}{5lemma}
\pmsynonym{short five lemma}{5lemma}
\pmsynonym{short 5-lemma}{5lemma}
\pmsynonym{five lemma}{5lemma}
\pmsynonym{5 lemma}{5lemma}
\pmrelated{9Lemma}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
If $A_i,B_i$ for $i=1,\ldots,5$ are objects in an abelian category (for example, modules over a ring $R$) such that there is a commutative diagram
$$\xymatrix{A_1\ar[r]\ar[d]^{\gamma_1}&A_2\ar[r]\ar[d]^{\gamma_2}&
A_3\ar[r]\ar[d]^{\gamma_3}&A_4\ar[r]\ar[d]^{\gamma_4}&A_5\ar[d]^{\gamma_5}\\
B_1\ar[r]&B_2\ar[r]&B_3\ar[r]&B_4\ar[r]&B_5}$$ with the rows exact, and $\gamma_1$ is surjective, $\gamma_5$ is injective, and $\gamma_2$ and $\gamma_4$ are isomorphisms, then $\gamma_3$ is an isomorphism as well.
