...
\usepackage{pmmeta}
\pmcanonicalname{C3categoryIsAb5}
\pmcreated{2013-03-22 18:26:17}
\pmmodified{2013-03-22 18:26:17}
\pmowner{bci1}{20947}
\pmmodifier{bci1}{20947}
\pmtitle{$C_3$-category is $ Ab5$}
\pmrecord{23}{41097}
\pmprivacy{1}
\pmauthor{bci1}{20947}
\pmtype{Definition}
...
\pmsynonym{Ab5 category}{C3categoryIsAb5}
\pmsynonym{cocomplete abelian category}{C3categoryIsAb5}
%\pmkeywords{$C_1$-category}
%\pmkeywords{$C_2$-category}
%\pmkeywords{monomorphisms family}
%\pmkeywords{products}
%\pmkeywords{coproducts and zero objects}
%\pmkeywords{Ab5 category}
%\pmkeywords{abelian category with generators}
...
\pmrelated{ExactSequenceTheoremInC_3Category}
\pmrelated{GabrielPopescuTheoremForAb5Categories}
\pmrelated{GrothendiecksTheorem}
\pmrelated{IndexOfCategories}
\pmdefines{Abelian cocomplete category}
