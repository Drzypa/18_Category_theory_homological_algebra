...
\usepackage{pmmeta}
\pmcanonicalname{GroupoidRepresentationsInducedByMeasure}
\pmcreated{2013-03-22 18:16:27}
\pmmodified{2013-03-22 18:16:27}
\pmowner{bci1}{20947}
\pmmodifier{bci1}{20947}
\pmtitle{groupoid representations induced by measure}
\pmrecord{27}{40879}
\pmprivacy{1}
\pmauthor{bci1}{20947}
\pmtype{Topic}
...
\pmsynonym{associated Haar system}{GroupoidRepresentationsInducedByMeasure}
%\pmkeywords{groupoid representations induced by measure are induced operators}
\pmrelated{Groupoids}
\pmrelated{LocallyCompactGroupoids}
\pmrelated{BorelGroupoid}
\pmdefines{associated Haar system}
\pmdefines{groupoid representation}
\pmdefines{measure induced operator}
\pmdefines{measure-preserving transformation}
\pmdefines{associated Haar system}
