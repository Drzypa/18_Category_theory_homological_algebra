...
\usepackage{pmmeta}
\pmcanonicalname{ExactSequenceTheoremInC3category}
\pmcreated{2013-03-22 18:26:29}
\pmmodified{2013-03-22 18:26:29}
\pmowner{bci1}{20947}
\pmmodifier{bci1}{20947}
\pmtitle{exact sequence theorem in $C_3$--category}
\pmrecord{12}{41101}
\pmprivacy{1}
\pmauthor{bci1}{20947}
\pmtype{Theorem}
...
\pmsynonym{$C_3$ category theorem}{ExactSequenceTheoremInC3category}
%\pmkeywords{$C_3$--category for direct family and exact sequence}
\pmrelated{C_3Category}
\pmrelated{ExactSequence2}
\pmrelated{CategoricalSequence}
\pmrelated{CategoricalSequence}
\pmdefines{$Im$}
\pmdefines{cocomplete Abelian category}
