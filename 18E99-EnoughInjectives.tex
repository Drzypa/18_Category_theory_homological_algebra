...
\usepackage{pmmeta}
\pmcanonicalname{EnoughInjectives}
\pmcreated{2013-03-22 13:51:54}
\pmmodified{2013-03-22 13:51:54}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{enough injectives}
\pmrecord{5}{34605}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
An abelian category is said to have {\em enough injectives} if for every object $X$, there is a monomorphism $0\to X\to I$ where $I$ is an \PMlinkname{injective}{InjectiveModule} object.
%%%%%
%%%%%
\end{document}
