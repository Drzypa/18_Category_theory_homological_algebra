...
\usepackage{pmmeta}
\pmcanonicalname{Site}
\pmcreated{2013-03-22 12:16:46}
\pmmodified{2013-03-22 12:16:46}
...
\pmsynonym{Grothendieck topology}{Site}
%\pmkeywords{etale cohomology}
%\pmkeywords{algebraic fundamental group}
%\pmkeywords{$l$-adic cohomology}
%\pmkeywords{crystalline cohomology}
%\pmkeywords{Weil conjectures}
...
\pmrelated{SomethingRelatedToSheaf}
\pmdefines{cover}
\pmdefines{covering}
\pmdefines{morphism of sites}
