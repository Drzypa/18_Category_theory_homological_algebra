...
\usepackage{pmmeta}
\pmcanonicalname{EquivalentRepresentationsOfGroupoids}
\pmcreated{2013-03-22 18:16:30}
\pmmodified{2013-03-22 18:16:30}
\pmowner{bci1}{20947}
\pmmodifier{bci1}{20947}
\pmtitle{equivalent representations of groupoids}
\pmrecord{25}{40880}
\pmprivacy{1}
\pmauthor{bci1}{20947}
\pmtype{Definition}
...
\pmsynonym{equivalence class of groupoid representations}{EquivalentRepresentationsOfGroupoids}
%\pmkeywords{representations}
%\pmkeywords{groupoids}
%\pmkeywords{equivalence class of groupoid representations}
%\pmkeywords{fiber-preserving}
\pmrelated{Groupoids}
\pmrelated{CAlgebra3}
\pmrelated{QuantumOperatorAlgebrasInQuantumFieldTheories}
\pmdefines{equivalent representations of groupoids}
...
\def\D{\mathsf{D}}
\begin{document}
\begin{definition}  Two representations of groupoids $(\mu_i, U_{\grp} * \H, L_i)$ , for $i=1,2$
are called \emph{equivalent} if $\mu_1 \sim \mu_2$, and if there also exists a fiber-preserving
isomorphism of analytical Hilbert space bundles $v: (U_{\grp}* \H_1)|_U \longrightarrow (U_{\grp}* \H_2)|_U$ ,
