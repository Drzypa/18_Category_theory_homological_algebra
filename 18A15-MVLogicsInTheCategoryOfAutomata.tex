...
\usepackage{pmmeta}
\pmcanonicalname{MVLogicsInTheCategoryOfAutomata}
\pmcreated{2013-03-22 19:15:57}
\pmmodified{2013-03-22 19:15:57}
\pmowner{bci1}{20947}
\pmmodifier{bci1}{20947}
\pmtitle{ MV-Logics in the Category of Automata }
\pmrecord{42}{42196}
\pmprivacy{1}
\pmauthor{bci1}{20947}
\pmtype{Topic}
...
\pmclassification{msc}{93B15}
\pmclassification{msc}{93A30}
\pmclassification{msc}{03G12}
\pmclassification{msc}{03G30}
\pmclassification{msc}{03G20}
\pmsynonym{LM-algebraic logic}{MVLogicsInTheCategoryOfAutomata}
\pmsynonym{algebraic automata theory}{MVLogicsInTheCategoryOfAutomata}
\pmsynonym{category of automata}{MVLogicsInTheCategoryOfAutomata}
%\pmkeywords{LM--algebraic logic}
%\pmkeywords{LM--logic algebras}
%\pmkeywords{algebraic category of LM-logic algebras}
%\pmkeywords{fundamental theorems of LM-logic algebra}
%\pmkeywords{centered n--\L{}ukasiewicz algebras}
%\pmkeywords{categories of n--\L{}ukasiewicz logic algebras}
%\pmkeywords{categories of Boolean logic algebras}
%\pmkeywords{Adjointn}
\pmdefines{quantum automata}
\pmdefines{quantum computer}
\pmdefines{Q-Logic}
\pmdefines{LM-logic algera}
\pmdefines{generalised $(M}
\pmdefines{R)$-systems}
\pmdefines{compact subsystems}
...
[34]
Moisil  Gr C (1964) Sur les logiques de $\L{u}$kasiewicz $\`a$ un nombre fini de valeurs. 
\emph{Rev. Roum. Math. Pures Appl.} \textbf{9}: 905--920.

[35] 
Moisil  Gr C (1965) \emph {Old and New Essays on Non-Classical Logics}. Editura Stiintzifica, Bucharest

[36] 
Moisil  Gr C (1967) \emph{``Th$\'e$orie structurelle des automats finis."}. Gauthiers-Villars, Paris

[37]
Moisil  Gr C (1968) \L{u}kasiewicz algebras. \emph{Computing Center: University of Bucharest}: (preprint--unpublished), pp.311-324.

[38]
Moisil  Gr C (1969) \emph{The Algebraic Theory of Switching Circuits} (orig. in Romanian). Editura Tehnica Bucuresti. (English translation in1969), Pergamon Press, Oxford and Editura Tehnica, Bucharest

[39]
Moisil  Gr C (1972) \emph{Essais sur les logiques non-chrysippiennnes.} Editura Academiei R.S. Romania, Bucharest.
...
[45]
Baianu I C, Glazebrook J F, and Georgescu G (2004) Categories of Quantum Automata and N-Valued Lukasiewicz Algebras in Relation to Dynamic Bionetworks, $(M,R)$-Systems and Their Higher Dimensional Algebra.  \emph{Abstract and Preprint of Report}:\\ http://www.medicalupapers.com/quantum+automata+math+categories+baianu/
